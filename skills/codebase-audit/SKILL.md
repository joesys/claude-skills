...
**MUST spawn 6 measurement agents in parallel** via the Agent tool — all 6 in a single response. Sequential dispatch is a defect. Read `references/agent-prompts.md` for the full prompt template for each agent.
