...
After §3.6 produces the mechanical synthesis, dispatch **one** Agent acting as a senior tech lead. This is the final judgment pass before the report reaches the user. **Always on by default**; suppressed only with `--no-re-review`.
