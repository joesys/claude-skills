...
**MUST dispatch all 6 agents in a single message using the Codex agent workflow.** Sequential dispatch is a defect.
...
**MUST dispatch all chapter writer agents in a single message using the Codex agent workflow.** Sequential dispatch is a defect.
