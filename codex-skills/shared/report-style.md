...
- User preferences (`.codex/skill-context/preferences.md`) still control detail level and explanation style. This file sets the baseline language; preferences tune it on top.
